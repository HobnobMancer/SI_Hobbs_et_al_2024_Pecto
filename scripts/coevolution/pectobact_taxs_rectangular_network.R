...
p.tree <- ggtree(tree, layout='rectangular') +
...
# PECTOBACTERIUM
geom_hilight(node=513, fill="#a6004d", extendto=0.65) + # P.brasillience
geom_hilight(node=605, fill="#e3026a", extendto=0.65) + # P.aqua
geom_hilight(node=599, fill="#ff479d", extendto=0.65) + # P.quasi
geom_hilight(node=591, fill="#ff6eb2", extendto=0.65) + # p.polaris
geom_hilight(node=587, fill="#ff82de", extendto=0.65) + # P.parvum
geom_hilight(node=421, fill="#d466b7", extendto=0.65) + # P.versatile
geom_hilight(node=472, fill="#b54597", extendto=0.65) + # P.carv
geom_hilight(node=496, fill="#962678", extendto=0.65) + # P.odor
geom_hilight(node=417, fill="#9926a3", extendto=0.65) + # P.actin
geom_hilight(node=392, fill="#9812a3", extendto=0.65) + #P.parmmentieri
geom_hilight(node=415, fill="#b808c7", extendto=0.65) + # P.punjabense
geom_hilight(node=414, fill="#da17eb", extendto=0.65) + # p.polonicun
geom_hilight(node=39, fill="#f047ff", extendto=0.65) + # P.wasab
geom_hilight(node=382, fill="#f473ff", extendto=0.65) + # P.astrospectum
geom_hilight(node=381, fill="#e68eed", extendto=0.65) + # P.peruo
geom_hilight(node=378, fill="#ce97de", extendto=0.65) + # P.zant
geom_hilight(node=375, fill="#bb81cc", extendto=0.65) + # p.colocasium
# DICKEYA
geom_hilight(node=690, fill="#0f49a6", extendto=0.65) + # d.solani
geom_hilight(node=727, fill="#145fd9", extendto=0.65) + # d.fang
geom_hilight(node=719, fill="#256ee6", extendto=0.65) + # d.diadantii
geom_hilight(node=688, fill="#4388fa", extendto=0.65) + # d.undi
geom_hilight(node=656, fill="#619bfa", extendto=0.65) + # d.dian
geom_hilight(node=649, fill="#79bef7", extendto=0.65) + # d.chry
geom_hilight(node=648, fill="#539edb", extendto=0.65) + # d.poaceiphilia
geom_hilight(node=635, fill="#459ee6", extendto=0.65) + # d.aquatica
geom_hilight(node=261, fill="#3b87c4", extendto=0.65) + # d.lacutsns
geom_hilight(node=618, fill="#2773b0", extendto=0.65) + # d.zeae
geom_hilight(node=613, fill="#1897d6", extendto=0.65) + # d.oryzae
# MUSICOLA
geom_hilight(node=632, fill="#694bd6", extendto=0.65) +
# BRENNERIA
geom_hilight(node=643, fill="#c99a20", extendto=0.65) +
geom_hilight(node=638, fill="#c99a20", extendto=0.65) +
# LONSDALEA
geom_hilight(node=642, fill="#339615", extendto=0.65)
...
while (countie < length(colnames(annot))) {
	...
	#
	p.heat <- gheatmap(p.tree, annot[i:j], offset=0.2, width=2.4, font.size=10, colnames_angle=-90, hjust=0) +
	  guides(fill=FALSE) +
