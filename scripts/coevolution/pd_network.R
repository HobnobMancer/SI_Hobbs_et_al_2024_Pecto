...
geom_hilight(node=433, fill="#00dec0", extendto=2.2) + # P.brasillience
geom_hilight(node=221, fill="#00a18b", extendto=2.2) +
geom_hilight(node=507, fill="#00a18b", extendto=2.2) + # P. polaris
geom_hilight(node=506, fill="#006356", extendto=2.2) + # P.parvum
geom_hilight(node=424, fill="#004963", extendto=2.2) + # P.quass
geom_hilight(node=419, fill="#00729c", extendto=2.2) + # P.aqua
geom_hilight(node=548, fill="#00a6e3", extendto=2.2) + # P.odor
geom_hilight(node=546, fill="#0071e3", extendto=2.2) + # P.actin
geom_hilight(node=532, fill="#004d9c", extendto=2.2) + # P.carv
geom_hilight(node=510, fill="#013a75", extendto=2.2) + # P.vers
geom_hilight(node=386, fill="#011275", extendto=2.2) + # p.parm
geom_hilight(node=122, fill="#001ab0", extendto=2.2) + # P.wass
geom_hilight(node=384, fill="#3d04c2", extendto=2.2) + # P.?
geom_hilight(node=411, fill="#551ce6", extendto=2.2) + # P.ast
geom_hilight(node=410, fill="#35128c", extendto=2.2) + # P.peruo
geom_hilight(node=407, fill="#402b78", extendto=2.2) + # P.zant
geom_hilight(node=377, fill="#644bad", extendto=2.2) + # p.carv2
geom_hilight(node=98, fill="#8a74e3", extendto=2.2) + # P.species
#######
geom_hilight(node=346, fill="#e80e0e", extendto=2.2) + # d.sal
geom_hilight(node=370, fill="#9e0808", extendto=2.2) + # d.dad
geom_hilight(node=333, fill="#660808", extendto=2.2) + # d.fan
geom_hilight(node=344, fill="#751035", extendto=2.2) + # d.undi
geom_hilight(node=310, fill="#9c0b40", extendto=2.2) + # d.dian
geom_hilight(node=302, fill="#cf0c53", extendto=2.2) + # d.oz
geom_hilight(node=298, fill="#e68cad", extendto=2.2) + # d.z
geom_hilight(node=16, fill="#f0699a", extendto=2.2) + # d.para
geom_hilight(node=292, fill="#cc62ae", extendto=2.2) + # d.chry
geom_hilight(node=308, fill="#a13081", extendto=2.2) + # d.pae
geom_hilight(node=287, fill="#731a5a", extendto=2.2) + # d.?
geom_hilight(node=285, fill="#4a103a", extendto=2.2) # musicola
...
while (countie < length(colnames(annot))) {
	...
	#}
  	countie <- j+1
	p.heat <- gheatmap(p.tree, annot[i:j], offset=0.5, width=2.4, font.size=10, colnames_angle=-90, hjust=0) +
	  guides(fill=FALSE) +
